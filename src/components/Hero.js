...
export default function Hero() {
  ...
  const accentStyle =
    "text-2xl sm:text-3xl md:text-5xl xl:text-8xl  mb-2 text-[var(--content_brand)] tracking-tight leading-tight";

  // px-8 sm:px-12 md:px-24 lg:px-40 xl:px-64 2xl:px-96

  return (
    <section className="min-h-[85vh] relative flex items-center justify-center px-6 relative z-10">
      ...
      <div className="w-full sm:w-5/6 xl:w-4/6 flex flex-col gap-12 items-center">
        <h1 className="text-2xl sm:text-3xl md:text-5xl xl:text-8xl font-bold text-[var(--content_dark)] leading-tight text-center tracking-tighter">
          {text}
